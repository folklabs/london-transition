...
export interface ApiInitiativeInitiative extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A Transition Town initiative in Greater London';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    rssFeedUrl: Schema.Attribute.String;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    status: Schema.Attribute.Enumeration<['active', 'inactive', 'unknown']> &
      Schema.Attribute.Required &
